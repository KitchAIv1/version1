...
export const useRecipeSuggestions = (selectedIngredients: string[]) => {
  ...
  return useQuery<RecipeSuggestionsResponse>({
    ...
    queryFn: async () => {
      ...
      console.log(
        '[useRecipeSuggestions] Fetching suggestions for ingredients:',
        selectedIngredients,
      );
      console.log('[useRecipeSuggestions] User ID:', user.id);
      console.log(
        '[useRecipeSuggestions] Ingredients being sent to backend:',
      ...
      console.log(
        '[useRecipeSuggestions] Successfully fetched suggestions:',
        data,
      );
      console.log(
        '[useRecipeSuggestions] Raw backend response structure:',
        JSON.stringify(data, null, 2),
      );
      console.log(
        '[useRecipeSuggestions] Database matches array:',
      ...
      return {
        ...
        total_matches:
          ...
          data.matches_returned ||
          mappedRecipeMatches.length,
