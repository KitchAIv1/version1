-- Fix username uniqueness issues in update_profile function
-- When p_username is NULL, don't update the username field at all
...
BEGIN
  ...
  SET 
    ...
    tier = CASE 
      ...
      WHEN p_role IS NULL THEN tier -- Don't change tier if role is not being updated
